...
ifeq ($(call is-board-platform-in-list,sdm660 sdm710 qcs605),true)
...
include $(DLKM_DIR)/AndroidKernelModule.mk
###########################################################
ifeq ($(call is-board-platform-in-list,msm8909 msm8952 msm8953 msm8937 sdm660 sdm710 qcs605),true)
include $(CLEAR_VARS)
