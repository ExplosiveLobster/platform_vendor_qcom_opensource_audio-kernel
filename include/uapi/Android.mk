...
$(GEN): PRIVATE_CUSTOM_TOOL = $(shell cd $(PRODUCT_OUT)/obj/KERNEL_OBJ; $(BUILD_ROOT)/$(HEADER_INSTALL_DIR)/headers_install.sh $(BUILD_ROOT)/$(dir $@) $(BUILD_ROOT)/$(subst $(UAPI_OUT),$(MYLOCAL_PATH),$(dir $@)) $(notdir $@))
